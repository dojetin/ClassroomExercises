...
public class Main {
	...
	public static void main(String[] args) {
		...
		do {
			System.out.println(" --------------------------------------------------------------------");
			System.out.println("|                Bienvenido al menú del San José                     |");
			System.out.println("|--------------------------------------------------------------------|");
			...
			System.out.println("|      9) Mostrar quien gana más de X                                |");
			...
			switch(eleccion) {
			 ...
			 case 9:{
				 System.out.println("¿Cual es el límtie de salario?");
	...
	static void introducirDatosPersona(Persona p) {
		...
		System.out.print("Introduca la fecha de nacimiento dia/mes/año: ");
		fecha= sc.nextLine();
	...
	private static void introducirDatosProfesor(Profesor p) {
		...
		System.out.print("Introduca la fecha que empezo a trabajar dia/mes/año: ");
